...
matchers = ['experiments_20210620135801']
...
def time_consuming(json_data , i):
    ...
    return [i, archive_len,initial_population_time,evaluation_population_time,assigning_distance_time,whole_process_time]
...
def producing_plot(df, path, name_of_file):
    if name_of_file == "time_information":
        ...
        plt.figure(figsize=(12, 5))
        plt.plot( names, successful_list, label='Successful member')
        plt.plot(names, failure_list,  label='Failure member')
