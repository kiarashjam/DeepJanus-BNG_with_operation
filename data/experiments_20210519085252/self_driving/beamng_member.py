...
from data.experiments_20210519085252.self_driving.catmull_rom import catmull_rom
from data.experiments_20210519085252.self_driving.road_bbox import RoadBoundingBox
from data.experiments_20210519085252.self_driving.road_polygon import RoadPolygon
from data.experiments_20210519085252.self_driving.edit_distance_polyline import iterative_levenshtein
...
class BeamNGMember(Member):
    ...
    def distance(self, other: 'BeamNGMember'):
        ...
        #TODO
        if self.mutation_type == 'MUT_FOG':
            return abs(self.fog_density - other.fog_density)
        elif self.mutation_type == 'MUT_RAIN':
