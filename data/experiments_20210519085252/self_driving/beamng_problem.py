...
from data.experiments_20210519085252.self_driving.beamng_evaluator import BeamNGEvaluator
from data.experiments_20210519085252.self_driving.beamng_individual import BeamNGIndividual
from data.experiments_20210519085252.self_driving.beamng_individual_set_store import BeamNGIndividualSetStore
from data.experiments_20210519085252.self_driving.beamng_member import BeamNGMember
from data.experiments_20210519085252.self_driving.road_generator import RoadGenerator
from data.experiments_20210519085252.self_driving.initial_population_generator import initial_pool_generator, initial_population_generator
...
class BeamNGProblem(Problem):
    ...
    def _get_evaluator(self):
        ...
        if ev_name == BeamNGConfig.EVALUATOR_FAKE:
            ...
            from data.experiments_20210519085252.self_driving.beamng_nvidia_runner import BeamNGNvidiaOob
